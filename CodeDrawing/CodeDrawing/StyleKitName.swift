...
public class StyleKitName : NSObject {
    ...
    private struct Cache {
        ...
        static let gradient: CGGradient = CGGradientCreateWithColors(CGColorSpaceCreateDeviceRGB(), [UIColor.redColor().CGColor, UIColor.redColor().blendedColorWithFraction(0.5, ofColor: UIColor.whiteColor()).CGColor, UIColor.whiteColor().CGColor, UIColor.whiteColor().blendedColorWithFraction(0.5, ofColor: gradientColor).CGColor, gradientColor.CGColor], [0, 0.14, 0.47, 0.84, 1])!
        static let gradient2: CGGradient = CGGradientCreateWithColors(CGColorSpaceCreateDeviceRGB(), [gradient2Color2.CGColor, gradient2Color2.blendedColorWithFraction(0.5, ofColor: gradient2Color).CGColor, gradient2Color.CGColor, UIColor.whiteColor().CGColor], [0.02, 0.21, 0.44, 1])!
